...
class RegressionARIMAModel(val regressionCoeff: Array[Double],
  ...
  override def addTimeDependentEffects(ts: org.apache.spark.mllib.linalg.Vector,
                                       dest: org.apache.spark.mllib.linalg.Vector): org.apache.spark.mllib.linalg.Vector = {
    throw new UnsupportedOperationException()
  }

  override def removeTimeDependentEffects(ts: org.apache.spark.mllib.linalg.Vector,
                                          dest: org.apache.spark.mllib.linalg.Vector): org.apache.spark.mllib.linalg.Vector = {
    throw new UnsupportedOperationException()
  }
}
