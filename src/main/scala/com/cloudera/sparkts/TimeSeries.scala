...
class TimeSeries[K](val index: DateTimeIndex, val data: DenseMatrix,
  ...
  /**
    ...
    *
    */
  def lags[U: ClassTag](maxLag: Int,
  ...
  /**
    ...
    *
    */
  def lags[U >: (K, Int)](maxLag: Int,
                          includeOriginals: Boolean): TimeSeries[(K, Int)] =
  ...
  /**
    ...
    */
  def lags[U: ClassTag](lagsPerCol: Map[K, (Boolean, Int)],
                        laggedKey: (K, Int) => U): TimeSeries[U] = {
  ...
  def filterByInstant(filterExpression: Double => Boolean,
    ...
    for (row <- 0 until numRows) {
      ...
      if (values.exists(filterExpression(_))) {
...
object TimeSeries {
  ...
  def timeSeriesFromIrregularSamples[K](samples: Seq[(ZonedDateTime, Array[Double])],
                                        keys: Array[K],
  ...
  /**
    ...
    */
  def timeSeriesFromUniformSamples[K](samples: Seq[Array[Double]],
  ...
  def timeSeriesFromVectors[K](vectors: Iterable[Vector],
                               index: DateTimeIndex,
                               keys: Array[K])
                              (implicit kClassTag: ClassTag[K])
  : TimeSeries[K] = {
